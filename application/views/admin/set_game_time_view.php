<div class="w3-twothird w3-center">
	...
	Current Server Time : <?= date('F,j Y,g:i a',time()) ?><br>
...
<span class="w3-text-indigo w3-serif">Minimum Live Required</span><br>

<select class="w3-padding" name='live_required'>
...
<br><br>
<textarea id="contents" placeholder="Article contents" class="w3-center w3-border-blue-grey" name="info-text"  value="<?php  echo set_value('info-text'); ?>" rows="15" cols="45"></textarea><br>
<br>
...
<div class="w3-container w3-padding">
	Current Start Time : <?= date('F,j Y,g:i a',$quiz_start) ?><br>
		Current End Time : <?= date('F,j Y,g:i a',$quiz_end) ?>
