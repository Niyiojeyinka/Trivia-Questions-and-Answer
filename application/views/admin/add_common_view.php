...
<select class="w3-padding" name='position'>
...
<input type="text" class="w3-border-blue-grey w3-padding" name="name" value="<?php echo set_value('details'); ?>" placeholder="Name of Space"></input>
<br><br>
