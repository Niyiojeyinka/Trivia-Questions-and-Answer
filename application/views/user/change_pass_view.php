...
<div class='w3-row'>
    <i  style='margin-right:3%' class="fa fa-key
     ...
     <input class='w3-center w3-padding' type='password' name='pass' placeholder='Current Password'/>
</div>
...
<div class='w3-row'>
    <i  style='margin-right:3%' class="fa fa-unlock-alt
     w3-large w3-text-theme w3-center"></i>
     <input class='w3-center w3-padding' type='password' name='npass'  value="<?php echo set_value("npass"); ?>" placeholder='New Password'/>
</div>
...
<div class='w3-row'>
    <i  style='margin-right:3%' class="fa fa-unlock-alt
     w3-large w3-text-theme w3-center"></i>
     <input class='w3-center w3-padding' type='password' name='cpass'  value="<?php echo set_value("cpass"); ?>" placeholder='Confirm Password'/>
</div>
<br>
