...
public function like($slug,$type,$id,$receiver_id,$likes_array)
{
...
if ($type == 'p') {
              ...
              $data = array(
                      ...
                      'contents' => $sender_username.' Like your Board Post',
...
$this->db->update('topics', $data,array('slug' => $slug ));
      ...
      $data = array(
              'sender_id' => $_SESSION['id'],
              'receiver_id' => $receiver_id,
              'contents' => $sender_username.' Like your Reply',
              'type' => 'board_reply_like',
              'ref_id' => $id,
              'slug' => $slug,
              'status' => 'unread',
              'time' => time()
...
public function get_need_comment($comment_id)
{
...
if($sender_username != $receiver_username)
{
 $data = array(
          'sender_id' => $_SESSION['id'],
          'receiver_id' => $id,
          'contents' => $sender_username.' Just Replied to your Board Post',
