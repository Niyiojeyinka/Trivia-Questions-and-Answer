...
public function view_comment_like($slug,$comment_id)
{
...
$this->board_model->insert_view($slug);
  $data["title"] ="Pryper | ".ucfirst($data['item']['title']);
      $data["keywords"] ="pryper,questions,Trivia,africa,reward,";
      $data["author"] ="Pryper";
     $data["descriptions"] ="Pryper is a FREE Daily Quiz platform that reward its Users 
     for getting Trivia Questions Right.No Initial Payment or Registration fee required";
...
$data['needed_comment'] = $this->board_model->get_need_comment($comment_id);
    ...
    if(isset($_SESSION['id']))
      ...
      $this->load->view('user/common/board_upper_view',$data);
      $this->load->view('user/topic_single_needed_comment_view',$data);
      $this->load->view('user/common/post_content_view',$data);
      $this->load->view('common/footer_view',$data);
...
if(isset($_SESSION['id']))
{
    if($this->board_model->like($slug,$type,$id,$receiver_id,json_encode($likes_array)))
    {
      show_page('board/topic/'.$slug);
...
$data["title"] ="Pryper | Post New Topic";
      $data["keywords"] ="pryper,questions,Trivia,africa,reward,";
      $data["author"] ="Pryper";
     $data["descriptions"] ="Pryper is a FREE Daily Quiz platform that reward its Users 
     for getting Trivia Questions Right.No Initial Payment or Registration fee required";
